...
footer1.addEventListener("click", () => {
  if (mediaQuery.matches && footer1Menu.style.display === "none") {
    footer1Menu.style.display = "block";
    footer1Icon.className = "footer-heading--view";
  } else if (mediaQuery.matches && footer1Menu.style.display === "block"){
...
footer2.addEventListener("click", () => {
  ...
  if (mediaQuery.matches && footer2Menu.style.display === "none") {
...
footer3.addEventListener("click", () => {
  ...
  if (mediaQuery.matches && footer3Menu.style.display === "none") {
...
footer4.addEventListener("click", () => {
  ...
  if (mediaQuery.matches && footer4Menu.style.display === "none") {
...
footer5.addEventListener("click", () => {
  console.log("footer4 working");
  if (mediaQuery.matches && footer5Menu.style.display === "none") {
